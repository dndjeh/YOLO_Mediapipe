...
def flip_boxes_horizontally(boxes, img_width):
    ...
    Args:
        boxes (Tensor or ndarray): Boxes to be flipped. Each box should be in the format [x_min, y_min, x_max, y_max].
        img_width (int): Width of the image.

    Returns:
        Tensor or ndarray: Flipped boxes.
    """
    flipped_boxes = boxes.clone() if isinstance(boxes, torch.Tensor) else np.copy(boxes)
    
    # Flip x coordinates
    flipped_boxes[..., [0, 2]] = img_width - flipped_boxes[..., [0, 2]]
